    ...
    <div className='bg-[#2E2238] flex flex-col gap-10 items-center justify-center  lg:pt-24 pt-32 pb-10'>
      <div className='w-full flex justify-center'>
        <div className='absolute py- w-2/3 max-w-[640px] '>
          <div className='pr-5 w-fit lg:py-3 border-r border-dashed border-[#F8F7F5]'>
        ...
        <input defaultValue={"0x754E56Ce07ae030a02b5f3977Eee86C3841E4f0D "} className='w-2/3 max-w-[660px] pl-20 lg:text-[23px] tracking-[0.46px] lg:py-3 text-[#FFF] rounded-[14px] bg-transparent border py-3 px-3 border-dashed border-[#F8F7F5]' />
      </div>
