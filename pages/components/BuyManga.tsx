...
export default function BuyManga() {
  return (
    <div className='bg-[#2E2238] flex flex-col gap-10 items-center justify-center py-20'>
      <div className='w-full flex justify-center'>
        <div className='absolute w-2/3 max-w-[561px] '>
          <div className='pl-5 pr-5 w-fit py-3 border-r border-dashed border-[#F8F7F5]'>
        ...
        <input value={"00000000000000000000000000000000"} className='w-2/3 max-w-[561px] pl-20 lg:text-2xl lg:py-3  rounded-[14px] bg-transparent border border-dashed border-[#F8F7F5]' />
      </div>
      <button className="text-center py-5 px-8 text-neutral-100 text-[26px] font-bold leading-[34px] tracking-wide bg-gradient-to-r from-fuchsia-700 via-slate-500 to-green-500 rounded-[13px]" >
        Buy $Manga
      </button>
