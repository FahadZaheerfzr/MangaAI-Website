  ...
  return (
    <div className='bg-[#2E2238] flex flex-col gap-10 items-center justify-center  lg:pt-24 pt-32 pb-10'>
      ...
      <div className='flex flex-col lg:flex-row gap-5'>
        ...
        />
        <button onClick={mint} className='w-full lg:w-[180px] lg:py-3 lg:px-4 py-2 px-2 rounded-[10px] bg-gradient-to-r from-fuchsia-700 via-slate-500 to-green-500 text-[#FFF]'>
          Mint Manga
        </button>
