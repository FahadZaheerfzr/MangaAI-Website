    ...
    <div className='bg-main-purple lg:p-12 lg:pb-0 p-4 font-Lato '>
      ...
      <div className='lg:flex '>
        <div className='w-fit'>
          ...
          <div className='mt-5'>
          <div className='border-1 h-7 border-l border-fuchsia-900  rounded-full inline-block mb-2 mr-2 lg:ml-6  float-left ml-2 '></div>
          <a className='text-[#F8F7F5] underline " ' href="/">Buy Now</a>
