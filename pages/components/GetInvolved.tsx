...
<div className='bg-main-gray w-full h-full hidden lg:flex font-Lato flex-col justify-center items-center relative py-8 gap-4'>
      ...
      <div className='px-20 items-center justify-center pb-10 flex flex-col gap-4'>

                  <div className='flex gap-4'>
                          <div className='bg-main-gray-lighter p-8 rounded-3xl   justify-center relative z-10 w-1/2  lg:px-16 py-14 gap-4 flex flex-col'>
                              <h1 className='text-[#88C48A] lg:text-4xl font-extrabold capitalize  justify-center text-lg m-auto text-center '>
                              Participate in AI Art Contests
                              </h1>
                              <p className='text-[#F8F7F5]  m-auto text-justify text-[23px] font-medium'>
                          ...
                          <div className='bg-main-gray-lighter p-8 rounded-3xl   justify-center     z-10 w-1/2 lg:px-16 py-14 gap-4 flex flex-col'>
