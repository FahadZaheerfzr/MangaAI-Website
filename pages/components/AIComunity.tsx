...
<div className='bg-main-gray pb-14 font-Lato'>
    <h1 className=' w-fit m-auto pt-5' >
            ...
            <button className="rounded-md text-[#F8F7F5] bg-gradient-to-r from-fuchsia-700 via-slate-500 to-green-500 p-4 flex m-auto ">Create Your Anime Art Now <p className='ml-6 mt-1'><FaArrowRight/></p></button>
