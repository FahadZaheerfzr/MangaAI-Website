                  ...
                  <div className='flex flex-col lg:flex-row lg:items-center bg-main-gray h-full font-Lato'>
                        <div className='w-[89%] lg:w-1/2 p-3 ml-8 lg:ml-10 pt-[15%] lg:pt-5 font-Lato'>
                              ...
                              <div className='flex items-center gap-x-4 mt-5'>
                                    <button className="rounded-[13px] bg-gradient-to-r from-purple-500 to-green-500 lg:text-[26px] text-[13px] text-[#F8F7F5] lg:px-6 lg:py-4 px-2 py-2 font-custom7">Generate Anime Art</button>
                                    <div className='w-[1.5px] lg:w-[3px] h-[29px] lg:h-[57.009px] ml-1 bg-[#8F41B4] ' />            
                                    <p className='text-[#F8F7F5] text-sm lg:text-[26px] text-[13px] font-custom7'><u>Documentation</u></p>
                              </div>
                        </div>
